...
def write_log_file(log_file_name, losses, epoch, lrate, phase):
    with open(log_file_name, 'a') as f:
        f.write("\n{} LRate: {} Epoch: {} Loss: {} MSE: {} UnwarpL2: {} UnwarpSSIMloss: {}".format(
            phase, lrate, epoch, losses[0], losses[1], losses[2], losses[3]))
...
def train(args):
    ...
    for epoch in range(epoch_start, args.n_epoch):
        ...
        for i_val, (images_val, labels_val) in tqdm(enumerate(valloader)):
            ...
            if args.tboard:
                show_unwarp_tnsboard(
                    epoch+1, writer, uwpred, uworg, 8, 'Val GT unwarp', 'Val Pred Unwarp')
